					...
					<?php foreach ( $related_solutions as $related ) : ?>
						<div class="related-solution-card">
							...
							<div class="related-solution-content">
								<h3><a href="<?php echo esc_url( get_permalink( $related->ID ) ); ?>"><?php echo esc_html( $related->post_title ); ?></a></h3>
								<p><?php echo wp_kses_post( wp_trim_words( $related->post_excerpt, 20, '...' ) ); ?></p>
							</div>
						</div>
					<?php endforeach; ?>
				</div>
