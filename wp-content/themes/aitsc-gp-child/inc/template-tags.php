 ...
 * Returns array of service categories for contact form
 */
function aitsc_get_service_categories() {
	...
	return apply_filters( 'aitsc_service_categories', $options );
}
...
function aitsc_get_contact_info() {
	$info = array(
		'email'   => get_option( 'aitsc_contact_email', '' ),
		'phone'   => get_option( 'aitsc_contact_phone', '' ),
		'address' => get_option( 'aitsc_contact_address', '' ),
	);

	return apply_filters( 'aitsc_contact_info', $info );
}
